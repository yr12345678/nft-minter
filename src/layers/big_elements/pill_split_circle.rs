...
impl Layer for BigElementPillSplitCircle {
    ...
    fn exclusions(&self) -> Vec<std::any::TypeId> {
        vec![
            ...
            small_elements::flower::SmallElementFlower.type_id(),
            small_elements::four_circles::SmallElementFourCircles.type_id(),
            small_elements::small_circle::SmallElementCircle.type_id(),
            ...
            small_elements::small_triangle::SmallElementTriangle.type_id(),
