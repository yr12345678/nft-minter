...
impl Layer for SmallElementSquareShadow {
    fn generate(&self, random: &mut Random, base_color: &Option<HSL>) -> Vec<Element> {
        ...
        if random.roll::<u8>(100) < 80 {
            ...
            rectangle_shadow = rectangle_shadow.set("fill", HSL {lightness: color.lightness - 10, ..color}.as_string());
            ...
            elements.extend(vec![gradient.into(), rectangle_shadow.into(), rectangle.into()]);
        }
